...
\end{figure}
% figure should show reserved word; and "prvious" in this and the next figure.

\begin{figure}
\begin{center}
  \includegraphics[width=12cm]{fig-mem-alloc-1.pdf}
\end{center}
...
% Needs updating the free/used bits
% concurrency?
